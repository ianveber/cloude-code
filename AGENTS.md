# Agent instructions — ChatGPT + Claude + Cursor

This repo is Veta's operating system. **ChatGPT, Claude, and Cursor share one private memory cloud:** `./_claude-memory/` (see `docs/memory-cloud.md`).
...
4. `_claude-memory/ledger.md`
5. Any open file in `_claude-memory/handoffs/` addressed to this model
